...
export default function NotFound({ errorCode }: Props) {
    ...
    return (
        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            ...
            <h1 className="mb-4 text-7xl tracking-tight font-extrabold lg:text-9xl text-blue-600 dark:text-blue-500">{errorCode}</h1>
            
            { (errorCode === 404) ?
                <p className="mb-4 text-lg font-light text-gray-500 dark:text-gray-400">{t('404.msg')}</p>
                :
                <p className="mb-4 text-lg font-light text-gray-500 dark:text-gray-400">{t('500.msg')}</p>
            }
